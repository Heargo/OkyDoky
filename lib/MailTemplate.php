 ...
 * (merci à http://www.broculos.net/2008/03/how-to-make-simple-html-template-engine.html#.WODf9N-YFhE pour le code)
 * 
...
class MailTemplate {
    ...
    public function output() {
        ...
        if (!file_exists($this->file)) {
        	return "Error loading template file (" . basename($this->file) . ").<br />";
        }
