...
<div class="container">
	...
	<h1>CGU, politique de confidentialité et cookies</h1>

	<h2>À propos de Okydoky</h2>
    <p>Okydoky est un projet pédagogique créer dans le cadre d'un cours d'informatique à l'<a href="https://www.univ-smb.fr/">Université Savoie Mont-Blanc</a></p>
    <p>
    Ce projet est porté par les personnes suivantes :
        <ul>
            <li>Hugo REY</li>
            <li>Simon LEONARD</li>
            <li>Evan L'HUISSIER</li>
            <li>Romain NEGRO</li>
            <li>Juliette NEYRAT</li>
        </ul>
    </p>
    ...
    <p>Okydoky collecte des données personnelles :
        <ul>
            ...
            <li>lorsque vous postez des documents, envoyez des messages à une communauté ou toute autre forme de participation sur le site</li>
        </ul>
    </p>

    <h2>Où sont stockées vos données ?</h2>
    <p>
        Toute les données d'OkyDoky sont stocké chez OVH, en France.
    </p>

    <h2>Comment puis-je suppimer mes données ?</h2>
    <p>
        Étant un projet universitaire sur quelques mois, il se peut que nous n'ayons pas pensé à toute les réglementations.
    ...
    <p>
    Okydoky utilise aussi le <i>local storage</i> afin d'accéléré le chargement du site à travers un méchanisme de cache.
